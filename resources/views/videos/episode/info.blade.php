      ...
      <div class="row align-items-center">
         <div class="col-md-8">
            <div class="page-header-title">
               <h5 class="m-b-10">Add Episode Information</h5>
            </div>
         </div>
         <div class="col-md-4">
            <ul class="breadcrumb">
               ...
               <li class="breadcrumb-item"><a href="#!">Add Episode Information</a>
               </li>
            </ul>
         </div>
      </div>
                     ...
                     <div class="card-block">
                        ...
                        <form class="form-material" id="uploadForm" action="{{route('videos.episode.info.store')}}" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="form-group form-default">
                              ...
                              <span class="form-bar"></span>
                              <label class="float-label">Price <span class="req">*</span></label>
                           </div>
                           <div class="form-group form-default">
